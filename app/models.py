...
class Customer(Base):
    ...
    contact_profile: Mapped[dict] = mapped_column(JSON, default=dict)
...
class Order(Base):
    ...
    shipping_method_id: Mapped[str | None] = mapped_column(String(80), index=True)
    shipping_method: Mapped[str | None] = mapped_column(String(200), index=True)
    shipping_cost: Mapped[Decimal | None] = mapped_column(Numeric(18, 2))
    shipment_status: Mapped[str | None] = mapped_column(String(80), index=True)
    tracking_code: Mapped[str | None] = mapped_column(String(200), index=True)
    ...
    estimated_delivery: Mapped[str | None] = mapped_column(String(120))
    shipment_integrator: Mapped[str | None] = mapped_column(String(160), index=True)
    distribution_center_id: Mapped[str | None] = mapped_column(String(80), index=True)
    shipping_city: Mapped[str | None] = mapped_column(String(120), index=True)
    shipping_state: Mapped[str | None] = mapped_column(String(10), index=True)
